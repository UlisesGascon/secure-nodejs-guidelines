...
This repository/website is a propsal to elaborate a solid documentation regarding Node.js Security Model and Threat models including the current state of art for [the Node.js Security WG](https://github.com/nodejs/security-wg) of [Next10](https://github.com/nodejs/next-10) 
